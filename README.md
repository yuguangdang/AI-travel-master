...
This project demonstrates a travel planning assistant composed of multiple agents. A supervisor coordinates three sub assistants—flight, accommodation and car rental—to handle bookings, changes and cancellations using mock tools.
